...
import com.kokochi.study.FilmProject.util.FileUtil;
import com.kokochi.study.FilmProject.util.FileUtilImpl;
...
public class musicController {
    ...
    public String musicAddPost(MusicVO musicVO, MultipartHttpServletRequest request) throws Exception {
        log.info("music/music_add :: 음악 추가하기 POST :: " + musicVO);
        fileUtil.uploadMusic(request, musicVO);
